    ...
    <table style="width:600px;" cellpadding="0" cellspacing="1" class="formtable">
        <c:choose>
            <c:when test="${sproductPage.flag =='Y' && sessionScope.LOCAL_CLINET_USER.userName != 'SuperAdmin'}">
                ...
                <h1>
                	<font color="red">${sessionScope.LOCAL_CLINET_USER.userName}您只能更改仓库商品的价格为您的自定义价格，仓库商品的其它信息不能更改！/Puoi cambiare i prezzi delle Merci di Magazzino per la vostra usanza dei prezzi delle Merci di Magazzino di altre informazioni, non posso cambiare</font>
                </h1>
            </c:when>
            ...
            <c:otherwise>
                <tr>
                    <td align="right">
                        <label class="Validform_label">
                            ...
                            商品标题/Waren der tarifnrn:

                        </label>
                    </td>
                    <td class="value">
                        <input class="inputxt" type="hidden"  id="name" name="name"  value='${sproductPage.name}'/>
                ...
                <tr>
                    <td align="right">
                        <label class="Validform_label">
                            商品描述/Beschreibung der ware:
                        </label>
                    </td>
                    <td class="value">
                        <input class="inputxt" type="hidden" id="description" name="description" required="required"
                               value="${sproductPage.description}"/>
                        <input class="inputxt" id="description_c" datatype="*2-50" />:中文&nbsp;&nbsp;
                      	<input class="inputxt" id="description_g" />:德文
                        <span class="Validform_checktip"></span>
                    </td>
                </tr>
                <tr>
